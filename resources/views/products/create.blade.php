...
@section('content')
  <div class="main">
    ...
    <div class="main-body">
      <form class="form-project" action="/producto_nuevo" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('patch') }}
        ...
        <div class="div-left">
          <div class="div-top">
            <div class="input-div" id="name">
              ...
              <input class="input-project" type="text" name="name" value="{{ old('name') }}" autofocus>
            </div>
          </div>
          <div class="div-bottom">
            <div class="input-div" id="price">
              <label class="form-label" for="price">Precio</label>
              <input class="input-project" type="number" min="1" step="any" name="price" value="{{ old('price') }}">
            </div>
          </div>
        </div>
        <div class="div-right">

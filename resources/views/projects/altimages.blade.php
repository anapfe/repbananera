<div id="alt-imgs-box">
  ...
  @foreach ($project->images as $image)
    <div class="alt-img-box">
      ...
      {{-- {{ dd($project->id, $image->id)}} --}}
      <a class="delete-img" href="javascript:ajaxLoad({{ url('?project_id='. $project->id . '&image_id=') . $image->id}})"><i class="fa fa-times" aria-hidden="true"></i></a>

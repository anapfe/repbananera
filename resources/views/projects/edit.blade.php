    ...
    <div class="main-body">
      <form class="form-project" action="/admin/proyectos/editar/{{ $project->id }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="cajitas-form">
          ...
          <div class="flex">
            <img class="img-portada" src="{{ asset ( 'storage/' . $project->primary_img ) }}" id="placeholder" alt="imagen principal">
            <label class="primary-img custom-upload" for="primaryImgUpload">
              <i class="fa fa-camera"></i>
            </label>
            <input class="upload-file" type="file" name="primary_img" id="primaryImgUpload" accept="image/*">
            {{-- <div class="input-div">
          </div> --}}
        </div>
      </div>
